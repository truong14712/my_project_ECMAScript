...
const Signup = function () {
  ...
  useEffect(() => {
    ...
    form.validate({
      ...
      messages: {
        email: {
          required: "<div class='text-red-500 ml-2'>Bắt buộc nhập email</div>",
          minlength:
            "<div class='text-red-500 ml-2'>Bắt buộc nhập 6 ký tự</div>",
          email:
            "<div class='text-red-500 ml-2 flex justify-center'>Bắt buộc nhập email</div>",
        },
        password: {
          required:
            "<div class='text-red-500 ml-2'>Bắt buộc nhập mật khẩu</div>",
          minlength:
            "<div class='text-red-500 ml-2'>Bắt buộc nhập 6 ký tự</div>",
        },
        ten: {
        ...
        ho: {
          required: "<div class='text-red-500 ml-2'>Bắt buộc nhập họ</div>",
        },
      },
    });
  });
    ...
    <div class="md:flex w-full">
      ...
      <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
        <div class="text-center mb-10">
          <h1 class="font-bold text-3xl text-gray-900">Đăng ký</h1>
          <p>Nhập thông tin của bạn để đăng ký</p>
        </div>
        <div>
          <div class="flex -mx-3">
            <div class="w-1/2 px-3 mb-5">
              <label for="" class="text-xs font-semibold px-1">Họ</label>
              <div class="flex">
                ...
                <input type="text"
                  class="w-[320px] -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                  id="First_name" placeholder="John" name="ho">
              </div>
            </div>
            <div class="w-1/2 px-3 mb-5">
              <label for="" class="text-xs font-semibold px-1">Tên</label>
              <div class="flex">
                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i
                    class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                <input type="text"
                  class="w-[320px] -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                  placeholder="Smith" id="Last_name" name="ten">
              </div>
            </div>
          </div>
          <div class="flex -mx-3">
            <div class="w-full px-3 mb-5">
              ...
              <div class="flex">
                ...
                <input type="email"
                  class="w-[750px] -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
          ...
          <div class="flex -mx-3">
            <div class="w-full px-3 mb-12">
              <label for="" class="text-xs font-semibold px-1">Mật khẩu</label>
              <div class="flex">
                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i
          ...
          <div class="flex -mx-3">
            <div class="w-full px-3 mb-5">
              <button
                class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Đăng ký ngay</button>
            </div>
          </div>
        </div>
