    ...
    form.validate({
      ...
      messages: {
        email: {
          ...
          minlength: "<div class='text-red-500 ml-2'>Bắt buộc nhập 6 ký tự</div>",
          email: "<div class='text-red-500 ml-2 flex justify-center'>Bắt buộc nhập email</div>",
        },
        password: {
          required: "<div class='text-red-500 ml-2'>Bắt buộc nhập mật khẩu</div>",
          minlength: "<div class='text-red-500 ml-2'>Bắt buộc nhập 6 ký tự </div>",
        },
      },
    });
    ...
    <div class="md:flex w-full">
      ...
      <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
        <div class="text-center mb-10">
          <h1 class="font-bold text-3xl text-gray-900">Đăng nhập</h1>
        </div>
        <div>
          <div class="flex -mx-3">
          ...
          <div class="flex mb-8">
            <span class="w-full px-3 text-lg">
          ...
          <div class="flex -mx-3">
            <div class="w-full px-3 mb-5">
              <button
                class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Đăng nhập</button>
            </div>
          </div>
        </div>
